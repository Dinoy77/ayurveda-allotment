        ...
        <div style={styles.pageContent}>
          ...
          <div style={styles.contentSection}>
            ...
            <div style={styles.extraSection}>
              ...
              <p style={styles.paragraph}>APCI is committed to:</p>
              <ul style={styles.list}>
                <li style={styles.listItem}>Facilitating admission opportunities for eligible pharmacy students.</li>
                <li style={styles.listItem}>Creating awareness about recognised pharmacy education programmes.</li>
                <li style={styles.listItem}>Providing students and parents with reliable admission guidance.</li>
                <li style={styles.listItem}>Connecting aspiring students with suitable pharmacy institutions.</li>
                <li style={styles.listItem}>Promoting transparent and student-focused admission support.</li>
                <li style={styles.listItem}>Encouraging students to pursue professional careers in pharmacy and healthcare.</li>
              </ul>
            </div>
